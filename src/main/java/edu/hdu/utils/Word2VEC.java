...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		// cn.hdu.teng.Learn learn = new cn.hdu.teng.Learn();
		...
		// cn.hdu.teng.Word2VEC vec2 = new cn.hdu.teng.Word2VEC();
	...
	public void loadGoogleModel(String path) throws IOException {
		...
		try {
			...
			// System.out.println("the bin file contain size = " + size + ", words = " + words);
			String word;
			float[] vectors = null;
			for (int i = 0; i < words; i++) {
				word = readString(dis);
				// System.out.println(String.format("word = %s, i =%d", word, i));
